...
class TestDataCleaner(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.sample_data = {
            ...
            "content": "An alien was sighted in New York today. The alien was seen flying a UFO. <a href='ad.com'>Click here</a> for an amazing offer.",
            "date": "2021-12-01",
            "author": "John Doe",
            "tags": ["alien", "UFO", "New York"],
            "source": "https://alien-news.com/alien-sighting-new-york",
            "type": "text"
        }

    def test_remove_ads(self):
        cleaned_data = self.data_cleaner.remove_ads(self.sample_data)
        self.assertNotIn("<a href='ad.com'>Click here</a>", cleaned_data['content'])
